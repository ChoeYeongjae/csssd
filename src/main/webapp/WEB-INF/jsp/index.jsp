    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark  fixed-top" id="sideNav" style="background-color: #4374D9 !important;">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="resources/assets/img/logo.jpg" alt="..." /></span>
            </a>
            ...
            <section class="resume-section" id="experience">
                <div class="resume-section-content">
                    ...
                    <div id="Progress_Loading"><!-- 로딩바 -->
						<img src="resources/assets/img/progress.gif"/>
					</div>
