...
public class MainController {
	 ...
	 * */
	/*
	 * @RequestMapping(value="/launchingCrawling") public @ResponseBody
	 * List<HashMap<String,Object>> launchingCrawling() throws Exception{
	 * 
	 * String url = "https://coinvote.cc/coins/1&order_by=soon"; Document doc =
	 * null; try { doc = Jsoup.connect(url).get(); } catch (IOException e) {
	 * e.printStackTrace(); }
	 * 
	 * Element element = doc.
	 * select("body > div.container > div.row > div.coins-bg > div > div.regular-table"
	 * ).get(0);
	 * 
	 * Elements ie1 = element.select("div:nth-child("+ 2 +
	 * ") > div.coin-row.coin-row-s > div:nth-child(" + 2 + ") > p > a"); Elements
	 * ie2 = element.select("div:nth-child("+ 3 +
	 * ") > div.coin-row.coin-row-s > div:nth-child(" + 2 + ") > p > a"); Elements
	 * ie3 = element.select("div:nth-child("+ 4 +
	 * ") > div.coin-row.coin-row-s > div:nth-child(" + 2 + ") > p > a"); Elements
	 * ie4 = element.select("div:nth-child("+ 5 +
	 * ") > div.coin-row.coin-row-s > div:nth-child(" + 2 + ") > p > a"); Elements
	 * ie5 = element.select("div:nth-child("+ 6 +
	 * ") > div.coin-row.coin-row-s > div:nth-child(" + 2 + ") > p > a"); Elements
	 * ie6 = element.select("div:nth-child("+ 7 +
	 * ") > div.coin-row.coin-row-s > div:nth-child(" + 2 + ") > p > a"); Elements
	 * ie7 = element.select("div:nth-child("+ 8 +
	 * ") > div.coin-row.coin-row-s > div:nth-child(" + 2 + ") > p > a"); Elements
	 * ie8 = element.select("div:nth-child("+ 9 +
	 * ") > div.coin-row.coin-row-s > div:nth-child(" + 2 + ") > p > a"); Elements
	 * ie9 = element.select("div:nth-child("+ 10 +
	 * ") > div.coin-row.coin-row-s > div:nth-child(" + 2 + ") > p > a"); Elements
	 * ie10 = element.select("div:nth-child("+ 11 +
	 * ") > div.coin-row.coin-row-s > div:nth-child(" + 2 + ") > p > a");
	 * 
	 * String[] name = new String[10];
	 * 
	 * for(Element e : ie1 ) { name[0] =
	 * e.getElementsByAttribute("href").attr("href"); }
	 * 
	 * for(Element e : ie2 ) { name[1] =
	 * e.getElementsByAttribute("href").attr("href"); }
	 * 
	 * for(Element e : ie3 ) { name[2] =
	 * e.getElementsByAttribute("href").attr("href"); }
	 * 
	 * for(Element e : ie4 ) { name[3] =
	 * e.getElementsByAttribute("href").attr("href"); }
	 * 
	 * for(Element e : ie5 ) { name[4] =
	 * e.getElementsByAttribute("href").attr("href"); }
	 * 
	 * for(Element e : ie6 ) { name[5] =
	 * e.getElementsByAttribute("href").attr("href"); }
	 * 
	 * for(Element e : ie7 ) { name[6] =
	 * e.getElementsByAttribute("href").attr("href"); }
	 * 
	 * for(Element e : ie8 ) { name[7] =
	 * e.getElementsByAttribute("href").attr("href"); }
	 * 
	 * for(Element e : ie9 ) { name[8] =
	 * e.getElementsByAttribute("href").attr("href"); }
	 * 
	 * for(Element e : ie10 ) { name[9] =
	 * e.getElementsByAttribute("href").attr("href"); }
	 * 
	 ...
	 * Document docs = null;
	 * 
	 * try { docs = Jsoup.connect(urls).get(); } catch (IOException e) {
	 * e.printStackTrace(); }
	 * 
	 * Elements elements = docs.select("div.coin-top-row");
	 * 
	 * String names =
	 * elements.select("div.coin-top-row > div.coin-left-card > div.coin-row > h2").
	 * text(); String contract = elements.select("#bsc-a").text(); String discpt =
	 * elements.
	 * select("div.coin-top-row > div.coin-left-card > div.coin-description > p").
	 * text(); String data = elements.
	 * select("div.coin-top-row > div.coin-right-card > div > div > div > div:nth-child(3) > p"
	 * ).text();
	 * 
	 * dataList.put("names", names); dataList.put("contract", contract);
	 * dataList.put("discpt", discpt); dataList.put("data", data);
	 * 
	 * list.add(dataList);
	 * 
	 * }
